...
export function QuickStats({ guests, bedrooms, beds, bathrooms }: QuickStatsProps) {
  const stats = [
...
export function QuickStatsMobile({ guests, bedrooms, beds, bathrooms }: QuickStatsProps) {
  return (
